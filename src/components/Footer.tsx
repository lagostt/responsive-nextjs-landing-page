...
<footer
  className="bg-red-200 text-center text-neutral-800  lg:text-left mt-36  ">
  
  <div className="mx-6 py-10 text-center md:text-left px-16">
    <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4 ">
      <div className="">
        ...
        sur le recrutement, l&apos;administration du personnel, la formation, la gestion des relations 
        avec les salariés et les tiers.
        </p>
      </div>
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-neutral-800 "
            >Administration du personnel</a>
        </p>
        <p>
          <a href="#!" className="text-neutral-800 "
            >Gestion des relations avec les salariés et les tiers</a>
        </p>
      </div>
      <div>
        <h6
